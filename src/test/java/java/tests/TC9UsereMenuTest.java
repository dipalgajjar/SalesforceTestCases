...
public class TC9UsereMenuTest extends BaseTest{
	@BeforeClass
	...
	@Test
	public void Logout(Method name) throws IOException, InterruptedException {	
		WebDriver driver = BaseTest.getDriver();
		BaseTest.test.info("Driver configured");
		TC2UserNavMenu um = new TC2UserNavMenu(driver);
		Assert.assertTrue(um.Logout(), "");
		BaseTest.test.info("Clicked on Logout");	
		BaseTest.test.info("Logout from Salesforce App");	
	}
}
